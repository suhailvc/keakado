            ...
            child: Padding(
              ...
              child: wishList.wishIdList.contains(product!.id)
                  ? CircleAvatar(
                      ...
                      child: Image.asset(
                          'assets/image/whishlist_selected_icon-01 (1).png',
                          height: 20),
                    )
                  : CircleAvatar(
                      radius: MediaQuery.of(context).size.width * 0.03,
                      backgroundColor: Colors.white,
                      child: Image.asset(
                          "assets/image/whishlist_icon-01 (1).png",
                          height: 20),
                    ),
              // ? SvgPicture.asset(
              //     'assets/svg/whishlist_selected_icon.svg',
              //     // 'assets/svg/whishlist${wishList.wishIdList.contains(product!.id) ? "_selected" : ""}_icon.svg',
              //     height: 20,
              //   )
              // : SvgPicture.asset(
              //     'assets/svg/whishlist_icon.svg',
              //     height: 20,
              //   ),
              //  Icon(
              //   wishList.wishIdList.contains(product!.id)
