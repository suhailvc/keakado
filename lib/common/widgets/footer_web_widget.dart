                            ...
                            child: Column(
                              ...
                              children: [
                                const SizedBox(
                                    height: Dimensions.paddingSizeExtraLarge),
                                Text(
                                    splashProvider.configModel!.playStoreConfig!
                                                .status! &&
                                ...
                                splashProvider
                                    ...
                                    ? InkWell(
                                        onTap: () {
                                          _launchURL(splashProvider.configModel!
                                ...
                                const SizedBox(
                                    height: Dimensions.paddingSizeLarge),
                                (splashProvider.configModel?.appStoreConfig
                                            ?.status ??
                                        false)
                                    ? InkWell(
                                        onTap: () {
                          ...
                          children: [
                            ...
                            TextHoverWidget(builder: (hovered) {
                              return InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(
                                        context, RouteHelper.orderListScreen);
                                  },
              ...
              child: Row(
                ...
                children: [
                  Consumer<SplashProvider>(
                    ...
                    final isLtr = Provider.of<LocalizationProvider>(context,
                            listen: false)
                        .isLtr;

                    return splashProvider.configModel!.socialMediaLink !=
                                null &&
                            splashProvider
