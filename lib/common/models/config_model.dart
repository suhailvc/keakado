...
class DeliveryManagement {
  ...
  DeliveryManagement.fromJson(Map<String, dynamic> json) {
    _status = true; //'${json['status']}'.contains('1');
    _minShippingCharge = 0.0; //json['min_shipping_charge'].toDouble();
    _shippingPerKm = 0.0; //json['shipping_per_km'].toDouble();
  }
