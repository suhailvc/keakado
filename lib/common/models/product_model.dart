...
class Product {
  ...
  String? _itemCode; // New field for Item Code
  String? _approximateWeight; // New field for ApproximateWeight
  String? _approximateUom; // New field for ApproximateUom
  ...
  Product({
    ...
    String? itemCode,
    String? approximateWeight, // Add approximateWeight to the constructor
    String? approximateUom, // Add approximateUom to the constructor
  }) {
    _id = id;
    _name = name;
    ...
    _itemCode = itemCode;
    _approximateWeight = approximateWeight; // Initialize the new field
    _approximateUom = approximateUom; // Initialize the new field
  }
  ...
  String? get approximateWeight =>
      _approximateWeight; // Getter for approximateWeight
  String? get approximateUom => _approximateUom; // Getter for approximateUom
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    _approximateWeight = json['ApproximateWeight']; // Parse approximateWeight
    _approximateUom = json['ApproximateUom']; // Parse approximateUom
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['item_code'] = _itemCode;
    data['approximate_weight'] =
        _approximateWeight; // Add approximateWeight to JSON output
    data['approximate_uom'] =
        _approximateUom; // Add approximateUom to JSON output
...
//     int? maximumOrderQuantity,
//     CategoryDiscount? categoryDiscount,
//     String? itemCode, // Add itemCode in the constructor
//   }) {
//     _id = id;
//     _name = name;
//     _description = description;
...
//     _maximumOrderQuantity = maximumOrderQuantity;
//     _categoryDiscount = categoryDiscount;
//     _itemCode = itemCode; // Initialize the new field
//   }
...
//   int? get maximumOrderQuantity => _maximumOrderQuantity;
//   CategoryDiscount? get categoryDiscount => _categoryDiscount;
//   String? get itemCode => _itemCode; // Add a getter for itemCode
...
//         ? CategoryDiscount.fromJson(json['category_discount'])
//         : null;
//     _itemCode = json['ItemCode']; // Parse the itemCode field
//   }
...
//       data['category_discount'] = _categoryDiscount!.toJson();
//     }
//     data['item_code'] = _itemCode; // Add itemCode to the JSON output
//     return data;
//   }
// }
// class Product {
