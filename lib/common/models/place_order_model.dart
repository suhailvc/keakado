...
class Cart {
  ...
  int? _quantity;
  double? _taxAmount;
  String? _remarks; // New field for remarks
  ...
  Cart(
    ...
    _remarks = remarks; // Initialize remarks
  }
  ...
  set remarks(String? value) {
    _remarks = value; // Setter for remarks
  }
  ...
  Cart.fromJson(Map<String, dynamic> json) {
    ...
    _remarks = json['remarks']; // Parse remarks from JSON
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['remarks'] = _remarks; // Add remarks to JSON
    return data;
  }

  @override
  String toString() {
    return 'Cart(productId: $_productId, price: $_price, variant: $_variant, '
        'discountAmount: $_discountAmount, quantity: $_quantity, '
        'taxAmount: $_taxAmount, variation: $_variation, remarks: $_remarks)';
  }
}
// class Cart {
//   int? _productId;
...
//     return 'Cart(productId: $_productId, price: $_price, variant: $_variant, '
//         'discountAmount: $_discountAmount, quantity: $_quantity, '
//         'taxAmount: $_taxAmount, variation: $_variation)';
//   }
// }
