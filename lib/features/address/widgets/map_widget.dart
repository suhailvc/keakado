...
class MapWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: ResponsiveHelper.isMobile() ? 175 : 250,
            ...
            onCameraIdle: () {
              if (address != null && !fromCheckout) {
                locationProvider.updatePosition(
                    locationProvider.cameraPosition, true, null, true);
              ...
              onTap: () {
                Navigator.pushNamed(
                  ...
                  arguments: SelectLocationScreen(
                      googleMapController: locationProvider.mapController),
                );
              },
              child: Container(
