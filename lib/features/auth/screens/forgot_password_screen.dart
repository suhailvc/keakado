...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isFirebase = configModel.customerVerification!.status! &&
        configModel.customerVerification?.type == 'firebase';
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomButtonWidget(
                              isLoading: (isFirebase &&
                                      verificationProvider.isLoading) ||
                                  (!isFirebase && authProvider.isLoading),
                              buttonText: getTranslated('send', context),
                              onPressed: () {
                                String email = _emailController.text.trim();
                                if (configModel.phoneVerification!) {
                                  String phone =
                                      '${CountryCode.fromCountryCode(_countryDialCode!).dialCode}$email';
                                  if (email.isEmpty) {
                                    ...
                                    if (isFirebase) {
                                      verificationProvider
                                          .firebaseVerifyPhoneNumber(phone,
