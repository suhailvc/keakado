  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Column(children: [
        ...
        CustomButtonWidget(
          buttonText:
              "${PriceConverterHelper.convertPrice(context, _total)}  ${getTranslated("checkout", context)}",
          onPressed: () {
            ...
            } else if (_itemPrice < _configModel.minimumOrderValue!) {
