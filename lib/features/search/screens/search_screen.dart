...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      // Fetch product suggestions dynamically based on input
      searchProvider.getSearchProductSuggestions(_searchController.text);
    });
  }
              ...
              child: Consumer<SearchProvider>(
                builder: (context, searchProvider, child) => Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Expanded(
                      child: searchProvider.suggestions.isNotEmpty
                          ? ListView.builder(
                          ...
                          : Center(
                              child: Text(
                                getTranslated('No Suggestions', context),
                                style:
                    ...
                    //       : Center(
                    //           child: Text(
                    //             getTranslated('no_suggestions', context),
                    //             style:
                    //                 poppinsMedium.copyWith(color: Colors.grey),
                    //           ),
                    //         ),
