  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Consumer<WalletAndLoyaltyProvider>(
            builder: (context, walletProvider, _) {
          entryList = WalletHelper.getPopupMenuList(
              walletFilterList: walletProvider.walletFilterList,
            ...
            child: _isLoggedIn
                ? configModel != null && configModel.walletStatus!
                    ? CustomScrollView(controller: scrollController, slivers: [
                        ...
                        if (!ResponsiveHelper.isDesktop(context))
                          SliverToBoxAdapter(child: Consumer<ProfileProvider>(
        ...
        Consumer<WalletAndLoyaltyProvider>(
          ...
          return PopupMenuButton<dynamic>(
            ...
            onSelected: (dynamic value) {
              walletProvider.setWalletFilerType(
                  walletProvider.walletFilterList[value].value!);
