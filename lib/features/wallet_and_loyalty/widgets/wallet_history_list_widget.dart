  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Consumer<WalletAndLoyaltyProvider>(
          builder: (context, walletProvider, _) => Center(
                  child: SizedBox(
                    ...
                    walletProvider.transactionList != null
                        ? walletProvider.transactionList!.isNotEmpty
                            ? ListView.separated(
                                ...
                                itemBuilder: (context, index) => WalletHistory(
                                    transaction:
                                        walletProvider.transactionList![index]),
                              )
                            : NoDataWidget(
                                isFooter: false,
                                title:
                                    getTranslated('no_result_found', context),
                              )
                        : WalletShimmerWidget(
                            isEnable: walletProvider.transactionList == null),
