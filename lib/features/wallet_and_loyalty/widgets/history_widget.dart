          ...
          Column(
            ...
            children: [
              ...
              if (data![index].createdAt != null)
                Text(
                  DateConverterHelper.formatDate(data![index].createdAt!),
                  style: poppinsRegular.copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
          ...
          //   )),
          // ),
          title: CustomDirectionalityWidget(
              child: Text(
            "${isDebit ? "-" : "+"}${isDebit ? transaction!.debit : transaction!.credit}",
            overflow: TextOverflow.ellipsis,
            maxLines: 1,
            style: poppinsSemiBold.copyWith(
              fontSize: Dimensions.fontSizeOverLarge,
              color: isDebit
                  ? Theme.of(context).colorScheme.error.withGreen(100)
          ...
          trailing: Column(
            ...
            children: [
              if (transaction!.createdAt != null)
                Text(
                  DateConverterHelper.isoStringToWalletDate(
              ...
              if (transaction!.createdAt != null) const SizedBox(height: 8),
              Text(
