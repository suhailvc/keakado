      ...
      return Dialog(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Flexible(
            ...
            itemBuilder: (index) {
              print(
                  '------qt-${orderProvider.reOrderCartList[index].quantity}');
              return Column(
...
class ReOrderProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CartProvider>(builder: (context, cartProvider, _) {
      bool isProductNotAvailable = (cartProvider.isExistInCart(cart) != null) ||
          (cart.stock != null && cart.stock! < 1);
      ...
      return Stack(children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: ((cartProvider.isExistInCart(cart) != null) ||
                    (cart.stock != null && cart.stock! < 1))
        ...
        if (orderDetailsModel.price != cart.price)
          Positioned.fill(
            child: Align(
