...
class OrderModel {
  ...
  int? _returnReference;
  int? _isReturnRequested; // Added field
  int? _isReturned; // Added field
  ...
  OrderModel({
    ...
    int? returnReference,
    int? isReturnRequested, // Added parameter
    int? isReturned, // Added parameter
  }) {
    _id = id;
    _userId = userId;
    ...
    _returnReference = returnReference;
    _isReturnRequested = isReturnRequested; // Set the value
    _isReturned = isReturned; // Set the value
  }

  int? get returnReference => _returnReference;
  int? get id => _id;
  ...
  OfflinePaymentInformation? get offlinePaymentInformation =>
      _offlinePaymentInformation;
  List<OrderImage>? get orderImageList => _orderImageList;

  int? get isReturnRequested => _isReturnRequested; // Getter for new field
  set isReturnRequested(int? value) {
    _isReturnRequested = value; // Setter for new field
  }

  int? get isReturned => _isReturned; // Getter for new field
  set isReturned(int? value) {
    _isReturned = value; // Setter for new field
  }
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    _orderPartialPayments = json["partial_payment"] == null
        ? []
        : List<OrderPartialPayment>.from(json["partial_payment"]!
            .map((x) => OrderPartialPayment.fromMap(x)));
    _offlinePaymentInformation = json["offline_payment_information"] == null
        ? null
        : OfflinePaymentInformation.fromMap(
            json["offline_payment_information"]);
    _orderImageList = json["order_image"] == null
        ? []
        : List<OrderImage>.from(
            json["order_image"]!.map((x) => OrderImage.fromMap(x)));
    _returnReference = json['return_reference'];
    _isReturnRequested =
        json['is_return_requested']; // Added to handle new field
    _isReturned = json['is_returned']; // Added to handle new field
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['return_reference'] = _returnReference;
    data['is_return_requested'] = _isReturnRequested; // Added to JSON output
    data['is_returned'] = _isReturned; // Added to JSON output
    return data;
  }
}
...
class OfflinePaymentInformation {
  ...
  factory OfflinePaymentInformation.fromJson(String str) =>
      OfflinePaymentInformation.fromMap(json.decode(str));

  factory OfflinePaymentInformation.fromMap(Map<String, dynamic> json) =>
      OfflinePaymentInformation(
        paymentName: json["payment_name"],
        paymentNote: json["payment_note"],
        methodInformation: json["method_information"] == null
            ? []
            : List<MethodValue>.from(
                json["method_information"]!.map((x) => MethodValue.fromMap(x))),
      );
}
...
class MethodValue {
  ...
  factory MethodValue.fromMap(Map<String, dynamic> json) =>
      MethodValue(value: json[json.keys.first], key: json.keys.first);
}
...
class OrderImage {
  ...
  factory OrderImage.fromJson(String str) =>
      OrderImage.fromMap(json.decode(str));
