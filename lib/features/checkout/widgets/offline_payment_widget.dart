                ...
                return Column(mainAxisSize: MainAxisSize.min, children: [
                  Expanded(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      Text(
                        '${getTranslated('amount', context)} : ${PriceConverterHelper.convertPrice(context, orderProvider.partialAmount ?? OrderHelper.getTotalAmount(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                    SizedBox(
                        ...
                        child: CustomButtonWidget(
                          ...
                          buttonText: getTranslated('close', context),
                          width: 100,
                  ...
                  SizedBox(
                      height: MediaQuery.of(context).viewInsets.bottom * 0.9),
                ]);
              }),
            )));
  }
...
class _PaymentInfoWidget extends StatefulWidget {
  ...
  const _PaymentInfoWidget({Key? key, required this.methodInfo})
      : super(key: key);
