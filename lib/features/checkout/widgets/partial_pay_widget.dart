...
class PartialPayWidget extends StatelessWidget {
  ...
  const PartialPayWidget({Key? key, required this.totalPrice})
      : super(key: key);
                  ...
                  Positioned.fill(
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Opacity(
                          opacity: 0.1,
                          child: Image.asset(Images.walletPayment, width: 80),
                        ),
                      ),
                    ),
                  ),
                  ...
                  child: Column(
                      ...
                      children: [
                        Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Image.asset(Images.walletBackground,
                                  height: 30, width: 30),
                              const SizedBox(
                            ...
                            children: [
                              orderProvider.partialAmount != null || isSelected
                                  ...
                                  : Flexible(
                                      child: Text(
                                        getTranslated(
                                            'do_you_want_to_use_now', context),
                                        style: poppinsRegular.copyWith(
                                            color:
                                                Theme.of(context).primaryColor,
                                            fontSize: Dimensions.fontSizeLarge),
                              ...
                              Consumer<LocationProvider>(
                                ...
                                return InkWell(
                                  ...
                                  child: locationProvider.addressList == null &&
                                          orderProvider.isDistanceLoading
                                      ? const SizedBox()
                                      : Container(
                                          decoration: BoxDecoration(
                                            color: orderProvider
