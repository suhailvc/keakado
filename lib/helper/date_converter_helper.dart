...
class DateConverterHelper {
  ...
  static String isoStringToOrderDetailsDateTime(String dateTime) {
    return DateFormat('dd-MMM-yyyy  hh:mm aa')
  ...
  static String isoStringToWalletDate(DateTime dateTime) {
  ...
  static String getDateToDateDifference(
      DateTime dateTime, BuildContext context) {
    ...
    if (day == 0) {
      ...
      differenceValue =
          '$day ${getTranslated('days', context)} ${getTranslated('ago', context)}';
    } else if (month < 12) {
      differenceValue =
          '$month ${getTranslated(month > 1 ? 'months' : 'month', context)} ${getTranslated('ago', context)}';
    }
