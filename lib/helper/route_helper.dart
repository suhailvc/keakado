...
import 'package:flutter_grocery/features/auth/screens/otp_screen.dart';
import 'package:flutter_grocery/features/auth/screens/personal_details_screen.dart';
import 'package:flutter_grocery/features/auth/screens/phone_number_screen.dart';
import 'package:flutter_grocery/features/category/screens/all_subcategories.dart';
...
class RouteHelper {
  ...
  static String getMainRoute([String? navigation]) {
    log(navigation ?? "", name: "Navigation");
    log("$menu?navigation=$navigation", name: "Navigation Two");
    return "$menu?navigation=$navigation";
  }

  static String getLoginMenuRoute() => loginMenu;
  static String getLoginRoute() => login;
  static String getOtpRoute(String phone) => "$otp?phone=$phone";
  static String getCreateProfileRoute(String phone) =>
      "$createProfile?phone=$phone";
  static String getPhoneNumberRoute() => phoneNumber;
  ...
  static final Handler _menuHandler = Handler(
    ...
    return _routeHandler(
        child: BottomBarView(
      navigation: params['navigation']?[0],
    ));
  });

  static final Handler _loginHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: const LoginMenuScreen()));

  static final Handler _phoneNumberHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: const PhoneNumberScreen()));

  static final Handler _otpHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: OtpScreen(phone: params['phone'][0])));

  static final Handler _createProfileHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: CreateProfileScreen(phone: params['phone'][0])));

  static final Handler _loginMenuHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: const LoginMenuScreen()));
  ...
  static final Handler _subCategoriesHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    return _routeHandler(
        child: AllSubCategories(
      categoryId: params['category_id'][0],
      categoryName: params['category_name'][0],
    ));
  });
  ...
  static void setupRouter() {
    ...
    router.define(phoneNumber,
        handler: _phoneNumberHandler, transitionType: TransitionType.fadeIn);
    router.define(otp,
        handler: _otpHandler, transitionType: TransitionType.fadeIn);
    router.define(createProfile,
        handler: _createProfileHandler, transitionType: TransitionType.fadeIn);
    router.define(loginMenu,
        handler: _loginMenuHandler, transitionType: TransitionType.fadeIn);
    ...
    router.define(subCategories,
        handler: _subCategoriesHandler, transitionType: TransitionType.fadeIn);
