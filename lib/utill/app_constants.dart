...
class AppConstants {
  static const String appName = 'KeaKado';
  ...
  static const String sendOtpUri = '/api/v1/auth/sent-mobile-number'; // ?phone=
  static const String verifyOtpUri = '/api/v1/auth/confirm-otp'; // ?phone=&opt=
  // static const String createProfileUri =
  //     '/api/v1/auth/register?f_name=anu&l_name=a&email=anu@gmail.com&phone=30576475'; // ?f_name=&l_name&email=&phone=
  ...
  static const String brandProductsList = '/api/v1/brand-products';
